...
function mandelbrotZeichnen(stift, lage) {
  ...
  if (mandelAufGpu) {
     ...
     */
    const schritteDeckel = mandelBremse > 0.12 ? 15000 : 900;
    ...
    const zielMs = 1000 / 60;
    if (abstandMs > zielMs * 1.12) mandelBremse *= 0.88;
    else if (abstandMs < zielMs * 0.98) mandelBremse *= 1.02;
